...
public final class Database {
    ...
    Constructor
     */
    protected Database(@NotNull String identifier, @NotNull ConnectionFactory connectionFactory, @NotNull Scheduler scheduler, DatabaseScheme databaseScheme, LongSummaryStatistics summaryStatistics) {
    ...
    public static class DatabaseBuilder {
        ...
        public Database build() {
            if (identifier == null || identifier.isEmpty()) throw new IllegalArgumentException("The identifier cannot be null or empty.");
            if (connectionFactory == null) throw new IllegalArgumentException("The connection factory cannot be null.");
            if (scheduler == null) throw new IllegalArgumentException("The scheduler cannot be null.");
            if (databaseScheme == null) databaseScheme = new NormalDatabaseScheme("Undefined", new LinkedList<>());
