...
public final class SingleQuery extends Query {
    ...
    Constructor
     */
    protected SingleQuery(@NotNull String query, @NotNull LinkedList<Object> parametersList) {
        super(query);
    ...
    public void updatePreparedStatement(@NotNull PreparedStatement preparedStatement) throws SQLException {
        ...
        for (int i = 1; i <= parametersList.size(); i++) preparedStatement.setObject(i, parametersList.get(i - 1));
    }
